...
public class Frame {
	...
	public static void main(String[] args) {
		...
		JTextField txtField2 = new JTextField("abc",20);
...
//		panel.add(btn1,BorderLayout.WEST);
		...
		//btn1에 기능을 넣는다.(js의 eventlistener랑 같음)
//		btn1.addActionListener(new ActionListener() {
//			
//			@Override
//			public void actionPerformed(ActionEvent e) {
//				//txtArea에 문구를 추가하는것이다.
//				txtArea.append("you are so beautiful\n");
//				
//			}
//		});
		//label 영역에 txtArea에 내가 쓴글을 바꿀 수 있게 해줌.
		btn1.addActionListener(new ActionListener() {
